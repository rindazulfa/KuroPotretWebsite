            ...
            <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="" id="navbarDropdownpro" role="button" data-toggle="dropdown"
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="blog.blade.php" id="navbarDropdown" role="button"
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="blog.blade.php" id="navbarDropdown1" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    pages
                  </a>
