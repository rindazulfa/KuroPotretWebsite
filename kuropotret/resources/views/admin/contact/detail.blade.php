...
<div class="content-wrapper">
    <div class="content">
        <div class="breadcrumb-wrapper">
            <h1 class="mb-2">Detail Kritik dan Saran</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb p-0">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Detail Kritik dan Saran</li>
                </ol>
            </nav>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="form-row mb-4">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                ...
                                <h5 class="text-dark">{{$detail->pesan}}</h5>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form action="{{route('kritik.destroy', [$detail -> id_contact])}}" method="post">
                @csrf
                @method('delete')
