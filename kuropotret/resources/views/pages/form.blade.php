                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="lokasi" required id="location" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter The Location'" placeholder='Enter The Location'>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
